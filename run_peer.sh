...
$DPS2_DIR/application/build/application $TRACKER_IP $TRACKER_PORT $IP $PEER_PORT $DPS2_DIR/$EXPERIMENT_NAME/${IP}_${PEER_PORT}.trc $DPS2_DIR/$EXPERIMENT_NAME/out/${IP}_${PEER_PORT}.out 0 > $DPS2_DIR/$EXPERIMENT_NAME/${IP}_${PEER_PORT}.log
sleep infinity
