...
$DPS2_DIR/application/build/application $TRACKER_IP $TRACKER_PORT $IP $PEER_PORT $DPS2_DIR/$EXPERIMENT_NAME/$IP_$PEER_PORT.trc $DPS2_DIR/$EXPERIMENT_NAME/out/$IP_$PEER_PORT.trc
sleep infinity
